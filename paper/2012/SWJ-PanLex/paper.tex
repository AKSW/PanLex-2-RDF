...
Expressions are modeled as intances of \vocab{plx:Expression}.
...
texttt{plx:Language} and \texttt{plx:LanguageVariety} are introduced.
...
All approvers share the \texttt{plx:Approver} class. The characteristics of an approver are described using mainly triples with literal objects.
