...
\begin{itemize}
\item Expressions are modeled as intances of the class \texttt{\small plx:Expression}.
...
\texttt{\small plx:Iso639-1Code} and \texttt{\small plx:Iso639-3Code}. % manual linebreak
