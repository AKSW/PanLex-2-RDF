...
Whenever there is Linked Data making use of descriptions, such as labels, in any language with lexemes in citation form (lemmas), the data are potentially linkable to, and through, PanLex. Here we describe how we connected PanLex to the Linked Data network.
...
The (assertion) source entity should be refactored to model users and information sources as distinct entities.
